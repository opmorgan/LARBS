...
dotfilesrepo="https://github.com/opmorgan/dots.git"
progsfile="https://raw.githubusercontent.com/opmorgan/larbs/testing/programs.csv"
aurhelper="yay"
repobranch="larbs"
...
putgitrepo "$dotfilesrepo" "/home/$name/dots" "$repobranch"
